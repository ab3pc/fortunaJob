...
const handleSetModalForVacancies = () => {
  setModalForVacancies(false);
}
  return ReactDOM.createPortal(
    <div className={classNames("modalForVac")} onClick  = {handleSetModalForVacancies}>
      <div className="modal__inner">
        <div className="modal__content" onClick={(e) => e.stopPropagation()}>
          ...
          <button
            onClick={handleSetModalForVacancies}
            className="modal__close"
            type="button"
          >
            <img className="modal__close-img" src="img/close.svg" alt="" />
          </button>
        </div>
      </div>
    </div>,
